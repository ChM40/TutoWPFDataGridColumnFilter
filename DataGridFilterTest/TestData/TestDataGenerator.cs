...
namespace DataGridFilterTest.TestData
{
    public class TestDataGenerator : INotifyPropertyChanged
    {
        ...
        {
            return getRandomString(random.Next(5, 10)) + ", " +
                getRandomString(random.Next(5, 15)) + " " + 
                random.Next(0, 200);
        }
        ...
        private readonly string[] NAMES = new string[]
        {
            ...
            "Jime", "Anderry","Rustin","Ivadon","Nichardo","Jasey","Rent",
            "Millack","Alenn","Serrett","Tanifer","Syllica","Allickie",
            "Jacey","Janther","Racey","Alicherry","Clary","Kather","Bonna"
        };
